...
# saving the results
results_path = str(homeDir)+'/AWM4_data/processed/timepoints/location(S1)/slidingWindow'
...
plt.savefig(results_path + '/average_locationS1_spatiotemporal.png')
plt.close()
...
# Save the figure
plt.savefig(results_path + '/average_locationS1_spatiotemporal_significance.png')
plt.close()
...
#read the txt file
all_mean_timescores = np.loadtxt(results_path + '/all_locationS1_mean_timescores_SVM.txt')
all_mean_acrossalltimes = np.loadtxt(results_path + '/all_locationS1_mean_acrossalltimes_SVM.txt')
...
# Save the figure
plt.savefig(results_path + '/average_locationS1_spatiotemporal_significance.pdf')
plt.close()
