#encoding S2 for 4 way classifier#
...
# saving the results
results_path = str(homeDir)+'/AWM4_data/processed/timepoints/S2encoding(10)/4way'
...
for actSubj in sub_lst:
    ...
    idx_sp1 = [i for i in range(len(S2_values)) if S2_values[i] in [111, 112, 113, 114, 211, 212, 213, 214]]
    idx_sp2 = [i for i in range(len(S2_values)) if S2_values[i] in [121, 122, 123, 124, 221, 222, 223, 224]]
    idx_sp3 = [i for i in range(len(S2_values)) if S2_values[i] in [131, 132, 133, 134, 231, 232, 233, 234]]
    idx_sp4 = [i for i in range(len(S2_values)) if S2_values[i] in [141, 142, 143, 144, 241, 242, 243, 244]]
