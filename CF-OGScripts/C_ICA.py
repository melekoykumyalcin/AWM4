...
for actSubj in Subs: 
    fname = str(homeDir)+'/processed/ICAs/VP'+str(actSubj)+'_fastica-ica.fif'
    ...
    #CombTrials = mne.read_epochs(str(homeDir)+'/Results/CutEpochs/CutData_VP'+str(actSubj)+'_S'+str(se)+'-epo.fif')
